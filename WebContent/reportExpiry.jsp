    ...
    <body>
        ...
        <div class="main">
                ...
                <div class = "row">
                        ...
                        <input type="date" class="form-control" placeholder="ExpiryDate1" name="ExpiryDate1" id="ExpiryDate1" required >
                     
                     	<label class="form-label">Date To:</label>
                        <input type="date" class="form-control" placeholder="ExpiryDate2" name="ExpiryDate2" id="ExpiryDate2" required >
                     </div>
                         ...
                         <thead>
                             ...
                             <%   
                                ...
                                con = DriverManager.getConnection("jdbc:sqlserver://ids517.coo7k8kkfrdz.us-east-2.rds.amazonaws.com; databaseName=ids517","admin","ids5172020");
                                  ...
                                  String query = "select * from Product where ExpiryDate between ? and ?";
                                  PreparedStatement st = con.prepareStatement(query);
                                  String ExpiryDate1 = request.getParameter("ExpiryDate1");
                                  String ExpiryDate2 = request.getParameter("ExpiryDate2");
                                  System.out.println(ExpiryDate1);
                                  st.setString(1,ExpiryDate1);
                                  st.setString(2,ExpiryDate2);
